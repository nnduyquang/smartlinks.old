...
<div class="clearfix">
		<div class="left"><?php echo get_avatar( $comment, apply_filters( 'woocommerce_review_gravatar_size', '60' ), '', get_comment_author() ); ?></div>

		<div class="comment-text comment-content clearfix">

				<div class="meta comment-author">
					<span itemprop="author" class="author"><?php comment_author(); ?></span> <?php
/*
			...
			<div itemprop="description" class="description text"><?php comment_text(); ?></div>
