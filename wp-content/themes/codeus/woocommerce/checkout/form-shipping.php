...
<div class="woocommerce-shipping-fields clearfix">
			...
			<div class="woocommerce-billing-collumns">
				<div class="woocommerce-billing-collumn odd clearfix">
					<?php foreach ( $checkout->checkout_fields['shipping'] as $key => $field ) : ?>
						...
						<?php woocommerce_form_field( $key, $field, $checkout->get_value( $key ) ); $index++; ?>
	...
	<div class="shiping-address-continue shipping_address_bottom"><a class="button woocommerce-button-next-step"><?php _e( 'Continue', 'woocommerce' ); ?></a></div>
</div>
