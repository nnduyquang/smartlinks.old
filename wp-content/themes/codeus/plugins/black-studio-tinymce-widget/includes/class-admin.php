...
if ( ! class_exists( 'Black_Studio_TinyMCE_Admin' ) ) {
	...
	final class Black_Studio_TinyMCE_Admin {
		...
		public function enqueue_style() {
			...
			wp_enqueue_style(
				$style,
				get_template_directory_uri() . '/plugins/black-studio-tinymce-widget/css/' . $style . $suffix. '.css',
				array(),
				bstw()->get_version()
			);
		}
		...
		public function enqueue_script() {
			...
			wp_enqueue_script(
				$script,
				get_template_directory_uri() . '/plugins/black-studio-tinymce-widget/js/' . $script . $suffix . '.js',
		...
		public function wp_tiny_mce_init() {
			...
			$suffix = defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ? '' : '.min';
			echo "\t\t" . '<script type="text/javascript" src="' . get_template_directory_uri() . '/plugins/black-studio-tinymce-widget/js/' . $script . $suffix . '.js' . '"></script>' . "\n"; // xss ok
		}
